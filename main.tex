...
\geometry{
left=1.5cm, %% 1.5cm left margin
right=11cm, %% 11cm the right limit of the left part of the page (doesn't include the sidebars)
marginparwidth=6.8cm, %% 6.8cm changes the overview width
marginparsep=1.2cm, %% 1.2cm
top=1.25cm, %% 
bottom=1.25cm %% 
}
...
\begin{fullwidth}
  ...
  % Detail-oriented Computer Engineer with a background in data science and machine learning.Looking for a job opportunity to tackle real world problems by applying my skills collaboraࢢng with teams and developing advanced technical solutions.\\
  % I love challenging tasks and learning new technologies and techniques. I enjoy streamlining processes and automaࢢng tedious tasks, like data collection by web-scraping or auto-generating reports/documentation using Python.
