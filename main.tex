...
\geometry{
left=1.5cm,
right=12cm, %% 11 the right limit of the left part of the page (doesn't include the sidebars)
marginparwidth=9cm, %% 6.8 changes the overview width
marginparsep=1.2cm, %% 1.2
top=1.25cm, %% 
bottom=1.25cm %% 
}
